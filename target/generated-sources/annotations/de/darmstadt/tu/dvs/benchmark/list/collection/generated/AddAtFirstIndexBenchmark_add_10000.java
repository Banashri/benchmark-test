...
public final class AddAtFirstIndexBenchmark_add_10000 {
    ...
    public Collection<? extends Result> add_10000_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_addatfirstindexbenchmark0_0.add_10000());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_10000_thrpt_jmhLoop(control, res, l_addatfirstindexbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "add_10000", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void add_10000_thrpt_jmhLoop(InfraControl control, RawResults result, AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> add_10000_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0 = _jmh_tryInit_f_addatfirstindexbenchmark0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_10000_avgt_jmhLoop(control, res, l_addatfirstindexbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "add_10000", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void add_10000_avgt_jmhLoop(InfraControl control, RawResults result, AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> add_10000_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0 = _jmh_tryInit_f_addatfirstindexbenchmark0_0(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            add_10000_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_addatfirstindexbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_addatfirstindexbenchmark0_0.add_10000());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "add_10000", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void add_10000_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> add_10000_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0 = _jmh_tryInit_f_addatfirstindexbenchmark0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            add_10000_ss_jmhStub(control, batchSize, res, l_addatfirstindexbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_addatfirstindexbenchmark0_0.readyIteration) {
                l_addatfirstindexbenchmark0_0.tearDown();
                l_addatfirstindexbenchmark0_0.readyIteration = false;
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "add_10000", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void add_10000_ss_jmhStub(InfraControl control, int batchSize, RawResults result, AddAtFirstIndexBenchmark_1_jmh l_addatfirstindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
