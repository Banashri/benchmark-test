package de.darmstadt.tu.dvs.benchmark.stream.generated;
...
public final class CollectionsStreamBenchmark_sumParallelLinkedList {
    ...
    public Collection<? extends Result> sumParallelLinkedList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_collectionsstreambenchmark0_G.sumParallelLinkedList());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumParallelLinkedList_thrpt_jmhLoop(control, res, l_collectionsstreambenchmark0_G, l_blackhole1_0);
            ...
            if (control.isLastIteration()) {
                while(!CollectionsStreamBenchmark_1_jmh.tearTrialMutexUpdater.compareAndSet(l_collectionsstreambenchmark0_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
                try {
                    if (l_collectionsstreambenchmark0_G.readyTrial) {
                        l_collectionsstreambenchmark0_G.readyTrial = false;
                    }
                } finally {
                    CollectionsStreamBenchmark_1_jmh.tearTrialMutexUpdater.set(l_collectionsstreambenchmark0_G, 0);
                }
                synchronized(this.getClass()) {
                    f_collectionsstreambenchmark0_G = null;
                }
                f_blackhole1_0 = null;
            }
            Collection<Result> results = new ArrayList<Result>();
            results.add(new ThroughputResult(ResultRole.PRIMARY, "sumParallelLinkedList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumParallelLinkedList_thrpt_jmhLoop(InfraControl control, RawResults result, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> sumParallelLinkedList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumParallelLinkedList_avgt_jmhLoop(control, res, l_collectionsstreambenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "sumParallelLinkedList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumParallelLinkedList_avgt_jmhLoop(InfraControl control, RawResults result, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> sumParallelLinkedList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            sumParallelLinkedList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_collectionsstreambenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_collectionsstreambenchmark0_G.sumParallelLinkedList());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "sumParallelLinkedList", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumParallelLinkedList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> sumParallelLinkedList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            sumParallelLinkedList_ss_jmhStub(control, batchSize, res, l_collectionsstreambenchmark0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "sumParallelLinkedList", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumParallelLinkedList_ss_jmhStub(InfraControl control, int batchSize, RawResults result, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile CollectionsStreamBenchmark_1_jmh f_collectionsstreambenchmark0_G;
    
    CollectionsStreamBenchmark_1_jmh _jmh_tryInit_f_collectionsstreambenchmark0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_collectionsstreambenchmark0_G == null) {
                f_collectionsstreambenchmark0_G = new CollectionsStreamBenchmark_1_jmh();
            }
            if (!f_collectionsstreambenchmark0_G.readyTrial) {
                Field f;
                f = de.darmstadt.tu.dvs.benchmark.stream.CollectionsStreamBenchmark.class.getDeclaredField("elementsSize");
                f.setAccessible(true);
                f.set(f_collectionsstreambenchmark0_G, Integer.valueOf(control.getParam("elementsSize")));
                f_collectionsstreambenchmark0_G.setUp();
                f_collectionsstreambenchmark0_G.readyTrial = true;
            }
        }
        return f_collectionsstreambenchmark0_G;
    }
    ...
    static class CollectionsStreamBenchmark_1_jmh_B1 extends de.darmstadt.tu.dvs.benchmark.stream.CollectionsStreamBenchmark {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class CollectionsStreamBenchmark_1_jmh_B2 extends CollectionsStreamBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CollectionsStreamBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CollectionsStreamBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CollectionsStreamBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CollectionsStreamBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CollectionsStreamBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CollectionsStreamBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class CollectionsStreamBenchmark_1_jmh_B3 extends CollectionsStreamBenchmark_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class CollectionsStreamBenchmark_1_jmh extends CollectionsStreamBenchmark_1_jmh_B3 {
    }
