...
public final class CollectionsStreamBenchmark_sumLinkedList {
    ...
    public Collection<? extends Result> sumLinkedList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_collectionsstreambenchmark0_G.sumLinkedList());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumLinkedList_thrpt_jmhLoop(control, res, l_collectionsstreambenchmark0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "sumLinkedList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumLinkedList_thrpt_jmhLoop(InfraControl control, RawResults result, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> sumLinkedList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumLinkedList_avgt_jmhLoop(control, res, l_collectionsstreambenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "sumLinkedList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumLinkedList_avgt_jmhLoop(InfraControl control, RawResults result, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> sumLinkedList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            sumLinkedList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_collectionsstreambenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_collectionsstreambenchmark0_G.sumLinkedList());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "sumLinkedList", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumLinkedList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> sumLinkedList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G = _jmh_tryInit_f_collectionsstreambenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            sumLinkedList_ss_jmhStub(control, batchSize, res, l_collectionsstreambenchmark0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "sumLinkedList", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void sumLinkedList_ss_jmhStub(InfraControl control, int batchSize, RawResults result, CollectionsStreamBenchmark_1_jmh l_collectionsstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
