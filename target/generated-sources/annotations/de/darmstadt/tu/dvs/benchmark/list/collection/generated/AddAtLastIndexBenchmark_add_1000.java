...
public final class AddAtLastIndexBenchmark_add_1000 {
    ...
    public Collection<? extends Result> add_1000_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_addatlastindexbenchmark0_0.add_1000());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_1000_thrpt_jmhLoop(control, res, l_addatlastindexbenchmark0_0, l_blackhole1_1);
    ...
    public void add_1000_thrpt_jmhLoop(InfraControl control, RawResults result, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> add_1000_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_1000_avgt_jmhLoop(control, res, l_addatlastindexbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void add_1000_avgt_jmhLoop(InfraControl control, RawResults result, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> add_1000_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            add_1000_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_addatlastindexbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_addatlastindexbenchmark0_0.add_1000());
    ...
    public void add_1000_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> add_1000_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            add_1000_ss_jmhStub(control, batchSize, res, l_addatlastindexbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_addatlastindexbenchmark0_0.readyIteration) {
                l_addatlastindexbenchmark0_0.tearDown();
                l_addatlastindexbenchmark0_0.readyIteration = false;
    ...
    public void add_1000_ss_jmhStub(InfraControl control, int batchSize, RawResults result, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
