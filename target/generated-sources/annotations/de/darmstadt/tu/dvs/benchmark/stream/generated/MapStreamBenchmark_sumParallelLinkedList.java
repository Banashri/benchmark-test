...
public final class MapStreamBenchmark_sumParallelLinkedList {
    ...
    public Collection<? extends Result> sumParallelLinkedList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G = _jmh_tryInit_f_mapstreambenchmark0_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_mapstreambenchmark0_G.sumParallelLinkedList());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumParallelLinkedList_thrpt_jmhLoop(control, res, l_mapstreambenchmark0_G, l_blackhole1_0);
            ...
            if (control.isLastIteration()) {
                while(!MapStreamBenchmark_1_jmh.tearTrialMutexUpdater.compareAndSet(l_mapstreambenchmark0_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
                try {
                    if (l_mapstreambenchmark0_G.readyTrial) {
                        l_mapstreambenchmark0_G.readyTrial = false;
                    }
                } finally {
                    MapStreamBenchmark_1_jmh.tearTrialMutexUpdater.set(l_mapstreambenchmark0_G, 0);
                }
                synchronized(this.getClass()) {
                    f_mapstreambenchmark0_G = null;
                }
                f_blackhole1_0 = null;
            }
    ...
    public void sumParallelLinkedList_thrpt_jmhLoop(InfraControl control, RawResults result, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> sumParallelLinkedList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumParallelLinkedList_avgt_jmhLoop(control, res, l_mapstreambenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void sumParallelLinkedList_avgt_jmhLoop(InfraControl control, RawResults result, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> sumParallelLinkedList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            sumParallelLinkedList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_mapstreambenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_mapstreambenchmark0_G.sumParallelLinkedList());
    ...
    public void sumParallelLinkedList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> sumParallelLinkedList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            sumParallelLinkedList_ss_jmhStub(control, batchSize, res, l_mapstreambenchmark0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void sumParallelLinkedList_ss_jmhStub(InfraControl control, int batchSize, RawResults result, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile MapStreamBenchmark_1_jmh f_mapstreambenchmark0_G;
    
    MapStreamBenchmark_1_jmh _jmh_tryInit_f_mapstreambenchmark0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_mapstreambenchmark0_G == null) {
                f_mapstreambenchmark0_G = new MapStreamBenchmark_1_jmh();
            }
            if (!f_mapstreambenchmark0_G.readyTrial) {
                Field f;
                f = de.darmstadt.tu.dvs.benchmark.stream.MapStreamBenchmark.class.getDeclaredField("elementsSize");
                f.setAccessible(true);
                f.set(f_mapstreambenchmark0_G, Integer.valueOf(control.getParam("elementsSize")));
                f_mapstreambenchmark0_G.setUp();
                f_mapstreambenchmark0_G.readyTrial = true;
            }
        }
        return f_mapstreambenchmark0_G;
    }
    ...
    static class MapStreamBenchmark_1_jmh_B1 extends de.darmstadt.tu.dvs.benchmark.stream.MapStreamBenchmark {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class MapStreamBenchmark_1_jmh_B2 extends MapStreamBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(MapStreamBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(MapStreamBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(MapStreamBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(MapStreamBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(MapStreamBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(MapStreamBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class MapStreamBenchmark_1_jmh_B3 extends MapStreamBenchmark_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class MapStreamBenchmark_1_jmh extends MapStreamBenchmark_1_jmh_B3 {
    }
