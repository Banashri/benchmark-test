...
public final class AggregateBenchmark_sumLinkedList {
    ...
    public Collection<? extends Result> sumLinkedList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            AggregateBenchmark_1_jmh l_aggregatebenchmark0_G = _jmh_tryInit_f_aggregatebenchmark0_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_aggregatebenchmark0_G.sumLinkedList());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumLinkedList_thrpt_jmhLoop(control, res, l_aggregatebenchmark0_G, l_blackhole1_0);
            ...
            if (control.isLastIteration()) {
                while(!AggregateBenchmark_1_jmh.tearTrialMutexUpdater.compareAndSet(l_aggregatebenchmark0_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
                try {
                    if (l_aggregatebenchmark0_G.readyTrial) {
                        l_aggregatebenchmark0_G.readyTrial = false;
                    }
                } finally {
                    AggregateBenchmark_1_jmh.tearTrialMutexUpdater.set(l_aggregatebenchmark0_G, 0);
                }
                synchronized(this.getClass()) {
                    f_aggregatebenchmark0_G = null;
                }
                f_blackhole1_0 = null;
            }
    ...
    public void sumLinkedList_thrpt_jmhLoop(InfraControl control, RawResults result, AggregateBenchmark_1_jmh l_aggregatebenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> sumLinkedList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumLinkedList_avgt_jmhLoop(control, res, l_aggregatebenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void sumLinkedList_avgt_jmhLoop(InfraControl control, RawResults result, AggregateBenchmark_1_jmh l_aggregatebenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> sumLinkedList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            sumLinkedList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_aggregatebenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_aggregatebenchmark0_G.sumLinkedList());
    ...
    public void sumLinkedList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AggregateBenchmark_1_jmh l_aggregatebenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> sumLinkedList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            sumLinkedList_ss_jmhStub(control, batchSize, res, l_aggregatebenchmark0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void sumLinkedList_ss_jmhStub(InfraControl control, int batchSize, RawResults result, AggregateBenchmark_1_jmh l_aggregatebenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile AggregateBenchmark_1_jmh f_aggregatebenchmark0_G;
    
    AggregateBenchmark_1_jmh _jmh_tryInit_f_aggregatebenchmark0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_aggregatebenchmark0_G == null) {
                f_aggregatebenchmark0_G = new AggregateBenchmark_1_jmh();
            }
            if (!f_aggregatebenchmark0_G.readyTrial) {
                Field f;
                f = de.darmstadt.tu.dvs.benchmark.stream.AggregateBenchmark.class.getDeclaredField("elementsSize");
                f.setAccessible(true);
                f.set(f_aggregatebenchmark0_G, Integer.valueOf(control.getParam("elementsSize")));
                f_aggregatebenchmark0_G.setUp();
                f_aggregatebenchmark0_G.readyTrial = true;
            }
        }
        return f_aggregatebenchmark0_G;
    }
    ...
    static class AggregateBenchmark_1_jmh_B1 extends de.darmstadt.tu.dvs.benchmark.stream.AggregateBenchmark {
    ...
    static class AggregateBenchmark_1_jmh_B2 extends AggregateBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AggregateBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AggregateBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AggregateBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AggregateBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AggregateBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AggregateBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class AggregateBenchmark_1_jmh_B3 extends AggregateBenchmark_1_jmh_B2 {
    ...
    static final class AggregateBenchmark_1_jmh extends AggregateBenchmark_1_jmh_B3 {
    }
