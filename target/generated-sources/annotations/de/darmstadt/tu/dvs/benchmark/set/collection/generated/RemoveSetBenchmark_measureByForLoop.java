...
public final class RemoveSetBenchmark_measureByForLoop {
    ...
    public Collection<? extends Result> measureByForLoop_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_removesetbenchmark0_0.measureByForLoop(l_blackhole1_2);
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureByForLoop_thrpt_jmhLoop(control, res, l_blackhole1_2, l_removesetbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "measureByForLoop", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureByForLoop_thrpt_jmhLoop(InfraControl control, RawResults result, Blackhole_1_jmh l_blackhole1_2, RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> measureByForLoop_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0 = _jmh_tryInit_f_removesetbenchmark0_0(control, threadParams);
            Blackhole_1_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureByForLoop_avgt_jmhLoop(control, res, l_blackhole1_2, l_removesetbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "measureByForLoop", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureByForLoop_avgt_jmhLoop(InfraControl control, RawResults result, Blackhole_1_jmh l_blackhole1_2, RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> measureByForLoop_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0 = _jmh_tryInit_f_removesetbenchmark0_0(control, threadParams);
            Blackhole_1_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            measureByForLoop_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_blackhole1_2, l_removesetbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_removesetbenchmark0_0.measureByForLoop(l_blackhole1_2);
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "measureByForLoop", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureByForLoop_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Blackhole_1_jmh l_blackhole1_2, RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> measureByForLoop_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0 = _jmh_tryInit_f_removesetbenchmark0_0(control, threadParams);
            Blackhole_1_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            measureByForLoop_ss_jmhStub(control, batchSize, res, l_blackhole1_2, l_removesetbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_2.readyIteration) {
                l_blackhole1_2.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "measureByForLoop", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureByForLoop_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Blackhole_1_jmh l_blackhole1_2, RemoveSetBenchmark_1_jmh l_removesetbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
