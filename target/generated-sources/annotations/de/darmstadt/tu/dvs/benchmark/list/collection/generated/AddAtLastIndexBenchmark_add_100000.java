...
public final class AddAtLastIndexBenchmark_add_100000 {
    ...
    public Collection<? extends Result> add_100000_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0 = _jmh_tryInit_f_addatlastindexbenchmark0_0(control, threadParams);
            ...
            if (!l_addatlastindexbenchmark0_0.readyIteration) {
                l_addatlastindexbenchmark0_0.setup();
                l_addatlastindexbenchmark0_0.readyIteration = true;
            }
            if (!l_addatlastindexbenchmark0_0.readyIteration) {
                l_addatlastindexbenchmark0_0.setup();
                l_addatlastindexbenchmark0_0.readyIteration = true;
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_addatlastindexbenchmark0_0.add_100000());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_100000_thrpt_jmhLoop(control, res, l_addatlastindexbenchmark0_0, l_blackhole1_1);
            ...
            if (l_addatlastindexbenchmark0_0.readyIteration) {
                l_addatlastindexbenchmark0_0.tearDown();
                l_addatlastindexbenchmark0_0.readyIteration = false;
            }
            if (l_addatlastindexbenchmark0_0.readyIteration) {
                l_addatlastindexbenchmark0_0.tearDown();
                l_addatlastindexbenchmark0_0.readyIteration = false;
            ...
            if (control.isLastIteration()) {
                f_addatlastindexbenchmark0_0 = null;
                f_blackhole1_1 = null;
            }
    ...
    public void add_100000_thrpt_jmhLoop(InfraControl control, RawResults result, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> add_100000_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_100000_avgt_jmhLoop(control, res, l_addatlastindexbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void add_100000_avgt_jmhLoop(InfraControl control, RawResults result, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> add_100000_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            add_100000_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_addatlastindexbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_addatlastindexbenchmark0_0.add_100000());
    ...
    public void add_100000_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> add_100000_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            add_100000_ss_jmhStub(control, batchSize, res, l_addatlastindexbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_addatlastindexbenchmark0_0.readyIteration) {
                l_addatlastindexbenchmark0_0.tearDown();
                l_addatlastindexbenchmark0_0.readyIteration = false;
    ...
    public void add_100000_ss_jmhStub(InfraControl control, int batchSize, RawResults result, AddAtLastIndexBenchmark_1_jmh l_addatlastindexbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    AddAtLastIndexBenchmark_1_jmh f_addatlastindexbenchmark0_0;
    
    AddAtLastIndexBenchmark_1_jmh _jmh_tryInit_f_addatlastindexbenchmark0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_addatlastindexbenchmark0_0 == null) {
            AddAtLastIndexBenchmark_1_jmh val = new AddAtLastIndexBenchmark_1_jmh();
                Field f;
            f = de.darmstadt.tu.dvs.benchmark.list.collection.AddAtLastIndexBenchmark.class.getDeclaredField("type");
            f.setAccessible(true);
            f.set(val, control.getParam("type"));
            val.readyTrial = true;
            f_addatlastindexbenchmark0_0 = val;
        }
        return f_addatlastindexbenchmark0_0;
    }
    ...
    static class AddAtLastIndexBenchmark_1_jmh_B1 extends de.darmstadt.tu.dvs.benchmark.list.collection.AddAtLastIndexBenchmark {
    ...
    static class AddAtLastIndexBenchmark_1_jmh_B2 extends AddAtLastIndexBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddAtLastIndexBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddAtLastIndexBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddAtLastIndexBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddAtLastIndexBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddAtLastIndexBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddAtLastIndexBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class AddAtLastIndexBenchmark_1_jmh_B3 extends AddAtLastIndexBenchmark_1_jmh_B2 {
    ...
    static final class AddAtLastIndexBenchmark_1_jmh extends AddAtLastIndexBenchmark_1_jmh_B3 {
    }
