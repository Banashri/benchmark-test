...
public final class AddMapBenchmark_add_10000 {
    ...
    public Collection<? extends Result> add_10000_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_addmapbenchmark0_0.add_10000());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_10000_thrpt_jmhLoop(control, res, l_addmapbenchmark0_0, l_blackhole1_1);
    ...
    public void add_10000_thrpt_jmhLoop(InfraControl control, RawResults result, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> add_10000_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_10000_avgt_jmhLoop(control, res, l_addmapbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void add_10000_avgt_jmhLoop(InfraControl control, RawResults result, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> add_10000_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            add_10000_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_addmapbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_addmapbenchmark0_0.add_10000());
    ...
    public void add_10000_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> add_10000_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            add_10000_ss_jmhStub(control, batchSize, res, l_addmapbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_addmapbenchmark0_0.readyIteration) {
                l_addmapbenchmark0_0.tearDown();
                l_addmapbenchmark0_0.readyIteration = false;
    ...
    public void add_10000_ss_jmhStub(InfraControl control, int batchSize, RawResults result, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
