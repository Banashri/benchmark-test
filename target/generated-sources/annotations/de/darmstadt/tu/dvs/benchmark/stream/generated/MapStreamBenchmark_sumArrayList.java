...
public final class MapStreamBenchmark_sumArrayList {
    ...
    public Collection<? extends Result> sumArrayList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_mapstreambenchmark0_G.sumArrayList());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumArrayList_thrpt_jmhLoop(control, res, l_mapstreambenchmark0_G, l_blackhole1_0);
    ...
    public void sumArrayList_thrpt_jmhLoop(InfraControl control, RawResults result, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> sumArrayList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            sumArrayList_avgt_jmhLoop(control, res, l_mapstreambenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void sumArrayList_avgt_jmhLoop(InfraControl control, RawResults result, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> sumArrayList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            sumArrayList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_mapstreambenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_mapstreambenchmark0_G.sumArrayList());
    ...
    public void sumArrayList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> sumArrayList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            sumArrayList_ss_jmhStub(control, batchSize, res, l_mapstreambenchmark0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void sumArrayList_ss_jmhStub(InfraControl control, int batchSize, RawResults result, MapStreamBenchmark_1_jmh l_mapstreambenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
