...
public final class AddMapBenchmark_add_100000 {
    ...
    public Collection<? extends Result> add_100000_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            AddMapBenchmark_1_jmh l_addmapbenchmark0_0 = _jmh_tryInit_f_addmapbenchmark0_0(control, threadParams);
            ...
            if (!l_addmapbenchmark0_0.readyIteration) {
                l_addmapbenchmark0_0.setup();
                l_addmapbenchmark0_0.readyIteration = true;
            }
            if (!l_addmapbenchmark0_0.readyIteration) {
                l_addmapbenchmark0_0.setup();
                l_addmapbenchmark0_0.readyIteration = true;
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_addmapbenchmark0_0.add_100000());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_100000_thrpt_jmhLoop(control, res, l_addmapbenchmark0_0, l_blackhole1_1);
            ...
            if (l_addmapbenchmark0_0.readyIteration) {
                l_addmapbenchmark0_0.tearDown();
                l_addmapbenchmark0_0.readyIteration = false;
            }
            if (l_addmapbenchmark0_0.readyIteration) {
                l_addmapbenchmark0_0.tearDown();
                l_addmapbenchmark0_0.readyIteration = false;
    ...
    public void add_100000_thrpt_jmhLoop(InfraControl control, RawResults result, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> add_100000_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            add_100000_avgt_jmhLoop(control, res, l_addmapbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void add_100000_avgt_jmhLoop(InfraControl control, RawResults result, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> add_100000_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            add_100000_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_addmapbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_addmapbenchmark0_0.add_100000());
    ...
    public void add_100000_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> add_100000_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            add_100000_ss_jmhStub(control, batchSize, res, l_addmapbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_addmapbenchmark0_0.readyIteration) {
                l_addmapbenchmark0_0.tearDown();
                l_addmapbenchmark0_0.readyIteration = false;
    ...
    public void add_100000_ss_jmhStub(InfraControl control, int batchSize, RawResults result, AddMapBenchmark_1_jmh l_addmapbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    AddMapBenchmark_1_jmh f_addmapbenchmark0_0;
    
    AddMapBenchmark_1_jmh _jmh_tryInit_f_addmapbenchmark0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_addmapbenchmark0_0 == null) {
            AddMapBenchmark_1_jmh val = new AddMapBenchmark_1_jmh();
                Field f;
            f = de.darmstadt.tu.dvs.benchmark.map.AddMapBenchmark.class.getDeclaredField("type");
            f.setAccessible(true);
            f.set(val, control.getParam("type"));
            val.readyTrial = true;
            f_addmapbenchmark0_0 = val;
        }
        return f_addmapbenchmark0_0;
    }
    ...
    static class AddMapBenchmark_1_jmh_B1 extends de.darmstadt.tu.dvs.benchmark.map.AddMapBenchmark {
    ...
    static class AddMapBenchmark_1_jmh_B2 extends AddMapBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddMapBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddMapBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddMapBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddMapBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddMapBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(AddMapBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class AddMapBenchmark_1_jmh_B3 extends AddMapBenchmark_1_jmh_B2 {
    ...
    static final class AddMapBenchmark_1_jmh extends AddMapBenchmark_1_jmh_B3 {
    }
