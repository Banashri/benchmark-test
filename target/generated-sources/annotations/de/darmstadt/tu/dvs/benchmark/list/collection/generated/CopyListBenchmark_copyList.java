...
public final class CopyListBenchmark_copyList {
    ...
    public Collection<? extends Result> copyList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            CopyListBenchmark_1_jmh l_copylistbenchmark0_0 = _jmh_tryInit_f_copylistbenchmark0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                if (!l_copylistbenchmark0_0.readyInvocation) {
                    l_copylistbenchmark0_0.readyInvocation = true;
                }

                l_copylistbenchmark0_0.copyList(l_blackhole1_2);

                if (l_copylistbenchmark0_0.readyInvocation) {
                    l_copylistbenchmark0_0.tearDown();
                    l_copylistbenchmark0_0.readyInvocation = false;
                }

            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            copyList_thrpt_jmhLoop(control, res, l_blackhole1_2, l_copylistbenchmark0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                if (l_copylistbenchmark0_0.readyTrial) {
                    l_copylistbenchmark0_0.readyTrial = false;
                }
                f_blackhole1_2 = null;
                f_copylistbenchmark0_0 = null;
                f_blackhole1_1 = null;
            }
            Collection<Result> results = new ArrayList<Result>();
            results.add(new ThroughputResult(ResultRole.PRIMARY, "copyList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void copyList_thrpt_jmhLoop(InfraControl control, RawResults result, Blackhole_1_jmh l_blackhole1_2, CopyListBenchmark_1_jmh l_copylistbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> copyList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            CopyListBenchmark_1_jmh l_copylistbenchmark0_0 = _jmh_tryInit_f_copylistbenchmark0_0(control, threadParams);
            Blackhole_1_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            copyList_avgt_jmhLoop(control, res, l_blackhole1_2, l_copylistbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "copyList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void copyList_avgt_jmhLoop(InfraControl control, RawResults result, Blackhole_1_jmh l_blackhole1_2, CopyListBenchmark_1_jmh l_copylistbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> copyList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            CopyListBenchmark_1_jmh l_copylistbenchmark0_0 = _jmh_tryInit_f_copylistbenchmark0_0(control, threadParams);
            Blackhole_1_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            copyList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_blackhole1_2, l_copylistbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    if (!l_copylistbenchmark0_0.readyInvocation) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "copyList", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void copyList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Blackhole_1_jmh l_blackhole1_2, CopyListBenchmark_1_jmh l_copylistbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> copyList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            CopyListBenchmark_1_jmh l_copylistbenchmark0_0 = _jmh_tryInit_f_copylistbenchmark0_0(control, threadParams);
            Blackhole_1_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            copyList_ss_jmhStub(control, batchSize, res, l_blackhole1_2, l_copylistbenchmark0_0, l_blackhole1_1);
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "copyList", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void copyList_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Blackhole_1_jmh l_blackhole1_2, CopyListBenchmark_1_jmh l_copylistbenchmark0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    CopyListBenchmark_1_jmh f_copylistbenchmark0_0;
    
    CopyListBenchmark_1_jmh _jmh_tryInit_f_copylistbenchmark0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_copylistbenchmark0_0 == null) {
            CopyListBenchmark_1_jmh val = new CopyListBenchmark_1_jmh();
                Field f;
            f = de.darmstadt.tu.dvs.benchmark.list.collection.CopyListBenchmark.class.getDeclaredField("changeTypes");
            f.setAccessible(true);
            f.set(val, control.getParam("changeTypes"));
            f = de.darmstadt.tu.dvs.benchmark.list.collection.CopyListBenchmark.class.getDeclaredField("size");
            f.setAccessible(true);
            f.set(val, Integer.valueOf(control.getParam("size")));
            val.setup();
            val.readyTrial = true;
            f_copylistbenchmark0_0 = val;
        }
        return f_copylistbenchmark0_0;
    }
    ...
    static class CopyListBenchmark_1_jmh_B1 extends de.darmstadt.tu.dvs.benchmark.list.collection.CopyListBenchmark {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class CopyListBenchmark_1_jmh_B2 extends CopyListBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CopyListBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CopyListBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CopyListBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CopyListBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CopyListBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(CopyListBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class CopyListBenchmark_1_jmh_B3 extends CopyListBenchmark_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class CopyListBenchmark_1_jmh extends CopyListBenchmark_1_jmh_B3 {
    }
